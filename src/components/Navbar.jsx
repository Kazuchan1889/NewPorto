          ...
          <div className="w-9 h-9 rounded-xl overflow-hidden flex items-center justify-center font-bold text-white text-sm group-hover:scale-110 transition-transform duration-300">
            {heroData?.logoUrl ? (
              ...
              <svg viewBox="0 0 100 100" className="w-5 h-5 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 75L45 25L60 55" stroke="currentColor" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M32 55H53" stroke="currentColor" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M65 35V75H80" stroke="currentColor" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            )}
          </div>
